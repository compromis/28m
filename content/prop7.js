export default {
  val: {
    ...
    textDone: `<p>Durant aquests anys hem canviat totalment la inversió de recursos públics: hem passat de la “política de grans esdeveniments” de macroesdeveniments que no generaven ocupació de qualitat, a invertir perquè les empreses valencianes siguen més competitives, i atraure inversió internacional.</p>
      ...
      <p>El resultat és que gran empreses de la indústria sostenible i la innovació com Volkswagen, Hitachi, Toshiba, Mitsubishi, Siemens o Telekom ha obert o ampliat la seua indústria; i també hem relocalitzat producció industrial de sectors tradicionals com el tèxil i el calcer, i gràcies a això estem acompanyant la creació de milers de llocs de treball de qualitat.</p>`,
