export default {
  val: {
    ...
    toBeDone:
      "Anem a continuar impulsant i protegint el nostre camp. Ho farem ampliant l’actuació de l’oficina valenciana a Brusel·les per defensar la nostra agricultura. També potenciarem un índex de preus perquè es paguen preus justos als productors, i posarem en marxa una renda agrícola per a ajudar a la incorporació al camp de persones joves, per tal de garantir el relleu generacional.",
  },
  cas: {
    title: "Camp valencià amb futur",
    textDone:
